...
class Bayesian_Time_Decay:
    """
    Model expected scored goals at home and away as Bayesian Random variables
    with more importance weight attributed to recent games.
    """
    ...
    def __init__(self, games):
        ...
        self.games = df.loc[:, [
            "score1", "score2", "team1", "team2", "hg", "ag", "weight"]]
...
if __name__ == "__main__":
    ...
    if os.path.isfile("data/predictions/scores/bayesian_decay.csv"):
        past_predictions = pd.read_csv(
            "data/predictions/scores/bayesian_decay.csv")
        (
            pd.concat(
                [
                    past_predictions,
