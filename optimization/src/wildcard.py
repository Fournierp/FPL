...
def write():
    ...
    with col2:
        decay_med = st.slider("Medium-term WC Decay rate", min_value=0., max_value=1., value=0.8, step=0.02)
    with col3:
        decay_short = st.slider("Short-term WC Decay rate", min_value=0., max_value=1., value=0.7, step=0.02)
    ...
    if st.button('Run Optimization'):
        ...
        with st.spinner("Running Optimization ..."):
            ...
            df, chip_strat = tp.advanced_wildcard(
