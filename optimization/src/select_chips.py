...
def write():
    ...
    if st.button('Run Optimization'):
        ...
        with st.spinner("Running Optimization ..."):
            ...
            if (
                (wc_gw in (fh_gw, tc_gw, bb_gw) and wc_gw is not None) or
                (fh_gw in (wc_gw, tc_gw, bb_gw) and fh_gw is not None) or
                (tc_gw in (wc_gw, fh_gw, bb_gw) and tc_gw is not None) or
                (bb_gw in (fh_gw, tc_gw, wc_gw)) and bb_gw is not None):
